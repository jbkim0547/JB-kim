...
const _logger = debug.extend("ProviderLanguagesDataCard");
...
function ProviderLanguagesDataCard({ references, languages, ...props }) {
  _logger("rendering", props);

  const columns = [
    { field: "languageId", headerName: "Id", width: 70 },
    {
      field: "code",
      headerName: "Code",
      width: 120,
...
ProviderLanguagesDataCard.propTypes = {
...
export default ProviderLanguagesDataCard;
